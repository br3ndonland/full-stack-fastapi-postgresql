...
That would be useful if, for example, the project generator (`br3ndonland/full-stack-fastapi-postgresql`) was updated and you want to integrate or review the changes.
...
```bash
cookiecutter --config-file ./cookiecutter-config-file.yml --output-dir ../project-copy https://github.com/br3ndonland/full-stack-fastapi-postgresql
```
